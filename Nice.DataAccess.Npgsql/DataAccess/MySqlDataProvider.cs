...
namespace Grit.Net.DataAccess.Npgsql
{
    /// <summary>
    /// Npgsql数据库操作的帮助类
    /// </summary>
    public class NpgsqlDataProvider : DataProvider, IDisposable
    {
        private readonly string dbConnString;

        public NpgsqlDataProvider(DatabaseType _dataBase, string _dbConnString)
        {
